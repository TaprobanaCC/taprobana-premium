    ...
    <main className="site-shell">
        ...
        <section className="home-grid">
          <div className="hero-panel">
            ...
            <div className="hero-actions">
              <button className="gold-button" onClick={() => setView('auth')}>Create Member Account</button>
              <button className="ghost-button" onClick={() => setView('visitor')}>Explore Visitor Pavilion</button>
            </div>
          </div>
        ...
        <section className="content-section">
          ...
          <div className="cards-grid">
            <article className="feature-card">
              <img src="/images/supun.jpg" alt="About Taprobana" />
              <h3>About Taprobana</h3>
              <p>Founded in 2013, Taprobana Sports Club has grown into one of the most active Sri Lankan sporting communities in the UAE. Built on friendship, sportsmanship and community values, the club continues to unite members through sport, social events and community engagement.</p>
            </article>

            <article className="feature-card">
              <h3>Since 2013</h3>
              <p>For more than a decade, Taprobana Sports Club has created opportunities for friendship, sporting excellence, leadership and community development among Sri Lankans living in the United Arab Emirates.</p>
            </article>

            <article className="feature-card">
              <div className="victory-images">
                <img src="/images/cricket-legacy.jpg" alt="Taprobana cricket trophy legacy" />
                <img src="/images/badminton-legacy.jpg" alt="Taprobana badminton trophy legacy" />
              </div>
              <h3>Our Victories</h3>
              <p>Through cricket, badminton and community events, Taprobana Sports Club has built a proud legacy of championships, achievements and unforgettable moments.</p>
            </article>
      ...
      {view === 'admin' && admin && (
        <section className="admin-section">
          <h1>Committee Admin Panel</h1><p>Use this launch-ready panel to add visible notices and events. With Supabase configured, records are saved to the database.</p>
          <div className="two-column">
